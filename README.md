...
<p align="center">
  <strong>家族も、ペットも、やさしく見守る  🐾</strong>
</p>

おくすリングは、自分や家族の服薬の飲み忘れを防ぐことに特化した、シンプルなリマインダーサービスです。

服薬時間になるとLINEで通知が届き、通知からおくすリングを開いてワンタップで「飲んだよ」を記録できます。
...
ローカル環境では、LINEログインを行わずに動作確認できるよう、開発用ログイン機能を用意しています。
...
開発用ログイン画面から「招待確認ユーザー」としてログインし、以下のURLにアクセスしてください。
